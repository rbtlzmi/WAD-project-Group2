                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('patient') }}">
                                {{ __('Register Patient') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('patient.list') }}">
                                {{ __('Patients List') }}
                            </x-jet-dropdown-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('appointment.list') }}">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('prescription') }}">
                                {{ __('Assign Prescription') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('prescription.list') }}">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('billing.list') }}">
                                {{ __('Billing List') }}
                            </x-jet-dropdown-link>
